...
<a href="../views/agregar_actividad.php" class="btn btn-success mb-3">Agregar Nueva Actividad</a> 
...
<td> 
<a href="../views/editar_actividad.php?id=<?= $actividad['id_actividad'] ?>" class="btn btn-warning btn-sm">Editar</a> 
